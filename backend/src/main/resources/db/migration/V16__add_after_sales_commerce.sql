...
CREATE TABLE refunds (
    ...
    CONSTRAINT uk_refunds_source_attempt UNIQUE (source_id,attempt_no),
...
ALTER TABLE inventory_movements
    ...
    ADD CONSTRAINT chk_inventory_movements_restore CHECK ((type IN ('CANCEL_RESTORE','RETURN_RESTORE') AND payment_id IS NULL AND source_id IS NOT NULL) OR type NOT IN ('CANCEL_RESTORE','RETURN_RESTORE'));
UPDATE inventory_movements SET source_id=payment_id WHERE payment_id IS NOT NULL;
