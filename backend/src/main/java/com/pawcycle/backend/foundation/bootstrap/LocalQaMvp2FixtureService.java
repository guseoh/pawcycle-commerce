...
@Service
public class LocalQaMvp2FixtureService {
	...
	public LocalQaMvp2FixtureService(JdbcTemplate jdbcTemplate) {
	...
	private void validateExistingPlan(Map<String, Object> plan, long skuId) {
		...
		Integer itemCount = jdbcTemplate.queryForObject(
				...
				planVersionId,
				skuId);
		Integer allItemCount = jdbcTemplate.queryForObject(
		...
		if (versionCount == null || versionCount != 1
				...
				|| allItemCount == null || allItemCount != 1
	...
	private LocalQaBootstrapException fixtureConflict() {
		return new LocalQaBootstrapException("로컬 QA MVP2 Plan fixture가 기존 데이터와 충돌합니다.");
	}
}
