...
class SubscriptionBillingTrigger {
	...
	SubscriptionBillingTrigger(SubscriptionBillingProcessor processor){this.processor=processor;}
	@Scheduled(fixedDelayString="${pawcycle.commerce.billing.fixed-delay-ms:60000}") void processReady(){processor.processReadyPayments();}
}
