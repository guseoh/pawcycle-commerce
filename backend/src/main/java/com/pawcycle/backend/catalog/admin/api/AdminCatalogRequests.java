...
public final class AdminCatalogRequests {
  ...
  public static final class BrandPatch {
    ...
    @JsonSetter("logoUrl")
    public void readLogoUrl(String value) {
      logoUrl = value;
      logoUrlPresent = true;
    }
  ...
  public record OptionGroupCreate(
      @NotBlank @Size(max = 100) String name, @NotNull @PositiveOrZero Integer displayOrder) {}
  ...
  public record OptionValueCreate(
      @NotBlank @Size(max = 100) String value, @NotNull @PositiveOrZero Integer displayOrder) {}
  ...
  public record FacetOptionCreate(
      @NotBlank @Size(max = 100) String value, @NotNull @PositiveOrZero Integer displayOrder) {}
