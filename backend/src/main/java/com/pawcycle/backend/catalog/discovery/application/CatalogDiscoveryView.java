...
public record CatalogDiscoveryView(
    List<Category> categories, List<Brand> brands, List<CategoryFacets> categoryFacets) {
  ...
  public record Category(
      Long categoryId, String name, String slug, int displayOrder, List<Child> children) {
    public Category {
