...
public record ProductDetailView(
	...
	public ProductDetailView(
		...
		this(productId, name, null, petType, description, thumbnailUrl, category, List.of(), Trust.empty(), skus,
				skus.stream().anyMatch(SkuDetail::purchasable), null, List.of(), List.of());
	}
	...
	public record Image(Long imageId, String imageUrl, String altText, int displayOrder, String imageType) {}
	public record OptionGroup(Long optionGroupId, String name, int displayOrder, List<OptionValue> values) {
		public OptionGroup { values = List.copyOf(values); }
	}
	...
	public record SkuDetail(
		...
		public SkuDetail(Long skuId, String skuName, BigDecimal price, boolean subscribable,
				List<Integer> availableDeliveryCycles, int availableQuantity, boolean purchasable) {
			this(skuId, skuName, price, subscribable, availableDeliveryCycles, availableQuantity, purchasable, null, null, List.of());
		}
	...
	public record SelectedOption(Long optionGroupId, String groupName, Long optionValueId, String value) {}
}
