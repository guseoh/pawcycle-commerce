...
public interface SkuRepository extends JpaRepository<Sku, Long> {
  ...
  List<Sku> findAllByProductIdAndStatusOrderByDisplayOrderAscIdAsc(
      Long productId, com.pawcycle.backend.catalog.sku.domain.SkuStatus status);

  List<Sku> findAllByProductIdInAndStatusOrderByProductIdAscDisplayOrderAscIdAsc(
      Collection<Long> productIds, com.pawcycle.backend.catalog.sku.domain.SkuStatus status);
