...
public final class AdminCatalogViews {
  ...
  public record Category(
    ...
    public Category(Long categoryId, String name, String slug, int displayOrder, boolean active) {
  ...
  public record FacetDefinition(
      Long facetDefinitionId, String key, String name, List<FacetOption> options) {}
