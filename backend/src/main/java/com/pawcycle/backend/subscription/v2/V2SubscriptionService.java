...
public class V2SubscriptionService {
  ...
  public Map<String, Object> createPet(long memberId, Map<String, Object> body) {
    return petPlans.createPet(memberId, body);
  }

  public Map<String, Object> updatePet(long memberId, long petId, Map<String, Object> body) {
    return petPlans.updatePet(memberId, petId, body);
  }
  ...
  public Map<String, Object> pet(long memberId, long petId) {
  ...
  public V2Result createSubscription(long memberId, String key, Map<String, Object> body) {
    return result(creations.create(memberId, key, body));
  }
