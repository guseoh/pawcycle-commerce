...
@ConditionalOnProperty(
    prefix = "pawcycle.mvp2.reconciliation",
    name = "enabled",
    havingValue = "true")
public class V2SubscriptionController {
  ...
  public V2SubscriptionController(V2SubscriptionService service) {
    this.service = service;
  }

  @PostMapping("/pets")
  ResponseEntity<Map<String, Object>> createPet(
  ...
  Map<String, Object> updatePet(
      @AuthenticationPrincipal AuthenticatedMemberPrincipal principal,
      @PathVariable long petId,
      @RequestBody Map<String, Object> body) {
    return service.updatePet(principal.memberId(), petId, body);
  }
  ...
  ResponseEntity<Map<String, Object>> subscription(
      @AuthenticationPrincipal AuthenticatedMemberPrincipal principal,
