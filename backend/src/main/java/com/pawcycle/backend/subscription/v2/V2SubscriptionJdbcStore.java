...
class V2SubscriptionJdbcStore {
	...
	void updatePet(long memberId, long petId, String name, String breed, java.math.BigDecimal weightKg) { if (jdbc.update("UPDATE pets SET name=?,breed=?,weight_kg=? WHERE id=? AND member_id=?", name, breed, weightKg, petId, memberId) != 1) throw new V2ApiException(404, "PET_NOT_FOUND", "Pet을 찾을 수 없습니다."); }
