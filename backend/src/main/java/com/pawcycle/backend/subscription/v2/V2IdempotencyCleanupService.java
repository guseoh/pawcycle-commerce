...
public class V2IdempotencyCleanupService {
  ...
  public V2IdempotencyCleanupService(
      JdbcTemplate jdbc, Clock clock, V2SubscriptionMetrics metrics) {
    this.jdbc = jdbc;
    this.clock = clock;
  ...
  public CleanupResult deleteExpired(int batchSize) {
    ...
    try {
      ...
      CleanupResult result =
          new CleanupResult(creationRepaired, commandRepaired, creationDeleted, commandDeleted);
