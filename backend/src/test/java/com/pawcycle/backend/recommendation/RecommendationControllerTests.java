...
class RecommendationControllerTests {
	...
	void principalAndPetIdAreBoundToServiceAndResponseSerializesAsContracted() throws Exception {
		...
		RecommendationService.RecommendationResponse response = new RecommendationService.RecommendationResponse(List.of(
		...
		RecommendationService.RecommendationResponse actual = controller.products(
				new AuthenticatedMemberPrincipal(7L), 42L);
