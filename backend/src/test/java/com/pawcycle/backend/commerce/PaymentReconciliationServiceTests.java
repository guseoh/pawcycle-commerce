...
class PaymentReconciliationServiceTests {
	...
	void failedProcessingBillingUsesExplicitFailureAndRetryWithoutChargingAgain() {
		...
		when(billing.queryCharge("provider-order")).thenReturn(new TossBillingAdapter.ChargeResult("FAILED", "DECLINED"));

		Map<String,Object> work = new HashMap<>();
		work.put("id", 44L); work.put("type", "BILLING"); work.put("status", "PROCESSING"); work.put("provider_order_id", "provider-order"); work.put("reconciliation_attempts", 0);
		Map<String,Object> locked = new HashMap<>();
		locked.put("id", 44L); locked.put("order_id", 12L); locked.put("type", "BILLING"); locked.put("status", "PROCESSING"); locked.put("reconciliation_attempts", 1); locked.put("member_id", 2L); locked.put("source", "SUBSCRIPTION");
