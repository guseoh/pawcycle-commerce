...
| Draft 해제 후 CI | `gh pr checks 4 --watch --interval 5` | 통과. Repository Validation, Collaboration Notification 성공 |
...
Repository Validation 성공을 확인한 뒤 Ready for review로 전환했다.

Draft 해제 이벤트 후 Repository Validation과 Collaboration Notification도 성공했다.
