...
PR #50의 CodeRabbit과 Codex Review를 확인했다. endpoint별 반복, cold 명령, D4 canonical schema와 PR 상태 관련 지적은 유지한다. 사용자가 승인하지 않은 event-based container sampling·지표별 집계는 Approved 영역에서 제거하고 warm-up 적용 단위를 미결정으로 분리했다.
