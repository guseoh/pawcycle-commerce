...
PR 생성 후 CI와 CodeRabbit/Codex Review를 확인한다.

## AI 리뷰 미반영 항목과 이유

작업 시작 시점에는 미반영 항목이 없다. PR 리뷰에서 유효한 지적이 확인되면 승인 범위 안에서만 반영한다.
...
- 최종 commit과 push 결과는 PR 생성 후 기록한다.
