...
- 작업 브랜치: `ops/sre`
- PERF-004 부분 결과와 PERF-005 결정 요청의 최초 commit, PR 결과 기록과 리뷰 반영 commit은 `origin/ops/sre`의 PR #52 원격 이력에서 확인
- 최신 리뷰 반영 commit은 자기 SHA를 같은 commit 안에 기록할 수 없으므로 PR #52의 최신 head와 원격 이력에서 확인
