...
10. 각 warm 측정 단위에서 첫 iteration 직전 `before`, 30회 중 15번째 또는 10회 중 5번째 iteration 직후 `mid`, 마지막 iteration 직후 `after`의 event-based container 표본을 수집하고 PERF-003의 지표별 집계·nullable 규칙을 적용한다.
