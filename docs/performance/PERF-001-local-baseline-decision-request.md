...
| D2 SLI 후보 | D2-A 경계·읽기·lifecycle p50·p95·max, 쓰기 p50·max, status·오류·자원·환경 | 평균만, metric 확장, 즉시 SLO | Decision Required | 예 |
| D3 조건 | D3-A cold 3, warm-up 5, boundary·read·lifecycle 30, write 10, concurrency 1 | 축소안, 쓰기 표본 증가, concurrency 3, 장시간 부하 | Decision Required | 예 |
