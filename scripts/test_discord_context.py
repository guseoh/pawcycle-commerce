...
"""
    ...
    def test_release_readiness_maps_completed_runs_and_sanitizes_target_sha(self):
        ...
        cases = {
            ...
            "timed_out": ("release_readiness_failure", "Readiness 확인 실패"),
            "neutral": ("release_readiness_failure", "Readiness 확인 실패"),
            "skipped": ("release_readiness_failure", "Readiness 확인 실패"),
            "unknown": ("release_readiness_failure", "Readiness 확인 실패"),
        }
        ...
        malformed_titles = (
            "Production Release Readiness · INVALID-SHA-DO-NOT-EXPOSE",
            None,
        )
        for invalid_title in malformed_titles:
            with self.subTest(display_title=invalid_title):
                ...
                if invalid_title is not None:
                    run["display_title"] = invalid_title
